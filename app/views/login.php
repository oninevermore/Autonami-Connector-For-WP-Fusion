            ...
            <div class="d-flex flex-column-fluid flex-center mt-6 mt-lg-0">
                ...
                <div class="login-form login-signin">
                    ...
                    <form class="form" method="post"  novalidate="novalidate" id="kt_login_signin_form" action="<?=REAL_URL?>/login/logged_in">
                        ...
                        <div class="pt-lg-40 mt-lg-10 pb-15">
                            ...
                            <span class="text-muted font-size-h5">Dont have an account yet?
                            <a href="javascript:;" id="kt_login_signup" class="text-primary font-weight-bolder">Create an Account</a></span>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            <label class="font-size-h7 text-dark-50">Email</label>
                        ...
                        <div class="pb-lg-0 pb-10">
                            ...
                            <a href="<?=$model->google_auth_url?>" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                ...
                <div class="login-form login-signup hidden">
                    ...
                    <form class="form" method="post"  novalidate="novalidate" id="kt_login_signup_form" action="<?=REAL_URL?>/login/add-new-user">
                        ...
                        <!--begin::Form group-->
                        <div class="form-group">
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="First Name" name="fname" autocomplete="off" />
                        </div>
                        <!--end::Form group-->

                        <!--begin::Form group-->
                        <div class="form-group">
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="Last Name" name="lname" autocomplete="off" />
                        </div>
                        <!--end::Form group-->
